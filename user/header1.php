    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <?php if (isset($_SESSION['isLoggedIn']) && isset($_SESSION['userID'])) { ?>
          ...
          <a class="nav-link" href="arthuser.php"><i class="fas fa-home"></i> <b>Home</b> <span class="sr-only">(current)</span></a>
        </li>
          <li class="nav-item">
            <a class="nav-link" href="dashboard.php"><i class="fas fa-chart-bar"></i> <b>Dashboard</b></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="viewProductUser.php"><i class="fas fa-list-alt"></i> <b>View products</b></a>
          </li>
      ...
      <?php if (isset($_SESSION['isLoggedIn']) && isset($_SESSION['userID'])) { ?>
        <ul class="navbar-nav">
          ...
          if (isset($_SESSION['cart'])) { ?>
              ...
              <li class="nav-item">
                <a href="cartView.php"><img src="cart.png" style="width: 60px;" style="height: 10px;"></a>
              </li>
