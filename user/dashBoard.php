...
<body>
  ...
  <button class="btn btn-primary" onclick="navigateToCategory('latest')"><a href="viewProductUser.php" style="color:black">Latest Games</button></a>
</div>
