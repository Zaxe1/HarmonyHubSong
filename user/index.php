...
if (isset($_POST['submit'])) {
  ...
  if (password_verify($password, $userRow['password'])) {
    ...
    header("Location:arthuser.php");
  } else {
    echo "Invalid Password";
  }
}
else{
  $_SESSION['faillogin']="Invalid username or password";
}
}
?>
<!DOCTYPE html>
  ...
  <div class="container-fluid">
    <div id="formParent">
      <form id="Login form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        <fieldset>
          <legend style="color:cyan">Login form</legend>
          ...
          <div class="form-check">
            ...
            <label class="form-check-label" for="exampleCheck1" style="color:chartreuse">Check me out</label>
          </div>
          <br>
          <br>
          <br>
          ...
          <br>
          <p style="color:chartreuse">If you are a member, please <a href="signup.php"><i class="fas fa-user-plus"></i> SignUp</a> here.</p>
        </fieldset>
      </form>
    </div>
  </div>
